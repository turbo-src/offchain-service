...
describe("Pull request is updated", function () {
  ...
  it("Should allow vote on update", async function () {
    ...
    assert.deepEqual(
      openStatus,
     { status: 200, state: "open", repo_id: "joseph/demo",  fork_branch: "pullRequest9", "childDefaultHash": "defaultHash9", "defaultHash": "defaultHash9" },
      "Fail to stay open."
    );
    ...
    assert.deepEqual(
      mergeStatus,
     { status: 200, state: "update", repo_id: "joseph/demo",  fork_branch: "pullRequest9", "childDefaultHash": "defaultHash9b", "defaultHash": "defaultHash9" },
