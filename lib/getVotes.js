...
async function getVotes(
  ...
  try {
    ...
    console.log('(parseInt(data.yesTokenAmount) / 1_000_000)', (parseInt(data.yesTokenAmount) / 1_000_000))
    console.log('parseInt(data.yesTokenAmount)', parseInt(data.yesTokenAmount))
    console.log('parseInt(data.yesTokenAmount)', parseInt(data.yesTokenAmount))
    console.log('response.voteData.voteTotals', response.voteData.voteTotals)
    return response
  } catch (error) {
    console.log(error);
    return 500
